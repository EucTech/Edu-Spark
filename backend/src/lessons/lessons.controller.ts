...
export class LessonsController {
  ...
  @ApiResponse({ status: 200, description: 'Return list of lessons.', type: [LessonResponseDto] })
  ...
  @ApiResponse({ status: 200, description: 'Return lesson details.', type: LessonResponseDto })
