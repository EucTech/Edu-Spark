...
import { LoginResponseDto, StudentLoginResponseDto } from './dto/login-response.dto';
...
export class AuthController {
  ...
  @ApiResponse({ status: 201, description: 'Guardian successfully registered.', type: GuardianResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Login successful. Returns access token and user info.', type: LoginResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Login successful. Returns access token and user info.', type: StudentLoginResponseDto })
