...
export class GradeGroupsController {
  ...
  @ApiResponse({ status: 200, description: 'Return all grade groups.', type: [GradeGroupDto] })
  findAll() {
  ...
  @ApiResponse({ status: 201, description: 'Grade group successfully created.', type: GradeGroupDto })
  ...
  @ApiResponse({ status: 201, description: 'Grade groups successfully seeded.', type: [GradeGroupDto] })
  seed() {
