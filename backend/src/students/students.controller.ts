...
export class StudentsController {
  ...
  @ApiResponse({ status: 201, description: 'Student profile created.', type: StudentResponseDto })
  ...
  @Get()
  @ApiOperation({ summary: 'Get all students belonging to the logged-in guardian' })
  @ApiResponse({ status: 200, description: 'Return list of students.', type: [StudentResponseDto] })
  findAll(@Request() req) {
  ...
  @ApiResponse({ status: 200, description: 'Return student details.', type: StudentResponseDto })
